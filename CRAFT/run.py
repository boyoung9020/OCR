...
def parse_arguments():
    ...
    parser.add_argument('-f','--fullsize',default=False, action='store_true', help='fullsize or fitsize')
    ...
    # parser.add_argument('--test_folder', default='../HeadlineExtractor/runs/detect/exp/crops/HeadlineBox/', type=str, help='folder path to input images')
    parser.add_argument('--test_folder', default='../chi/', type=str, help='folder path to input images')
...
def delete_files(input_path):
    """Delete all files and directories under the specified directory."""
    # Delete all files and directories under the specified directory
...
if __name__ == '__main__':
    ...
    delete_files(output_segmentation_path)
